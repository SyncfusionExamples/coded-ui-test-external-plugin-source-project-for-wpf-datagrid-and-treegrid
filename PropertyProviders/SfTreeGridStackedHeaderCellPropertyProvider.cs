...
namespace Syncfusion.VisualStudio.TestTools.UITest.SfGridExtension
{
    ...
    public class SfTreeGridStackedHeaderCellPropertyProvider : IUIControlPropertyProvider
    {
        ...
        private Dictionary<string, UITestPropertyDescriptor> treeGridStackedHeaderCellProperties;
        public Dictionary<string, UITestPropertyDescriptor> TreeGridStackedHeaderCellProperties
        {
            get
            {
